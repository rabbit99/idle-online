...
## Project Context (TestGame)

- **Product**: 放置人生（放置＋輕度互動）
- **Stack**: React + Vite（純 CSS，無 Tailwind）
- **Current UI**: 深色系卡片版型、簡單互動、重可讀性
- **UI Goals**: 更乾淨、資訊層級清楚、適度動效、行動裝置可讀
- **Constraints**: 保留現有邏輯與結構、避免大量重構
